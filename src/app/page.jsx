...
import abous from '../../public/images/main page/about us.png';
...
export default async function Home() {
  ...
  try {
    ...
    bestsellerItems = await collection.find({ bestseller: true }).toArray();
  ...
  return (
    <div>
      <div className={classes.wrapper}>
        ...
        <div className={classes.button}>УЗНАТЬ БОЛЬШЕ</div>
      </div>
      <div className={classes.main}>
        ...
        <div className={classes.aboutUs}>
          <Image src={abous} alt='о нас' width={1024} height={872}/>
